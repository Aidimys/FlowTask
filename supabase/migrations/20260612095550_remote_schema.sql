...
drop policy "board_members_delete_policy" on "public"."board_members";

drop policy "board_members_insert_policy" on "public"."board_members";

drop policy "board_members_select_policy" on "public"."board_members";

drop policy "boards_select_policy" on "public"."boards";

drop policy "Users can insert columns" on "public"."columns";

drop policy "Users can view columns" on "public"."columns";

drop policy "columns_delete_policy" on "public"."columns";

drop policy "columns_insert_policy" on "public"."columns";

drop policy "columns_select_policy" on "public"."columns";

drop policy "columns_update_policy" on "public"."columns";

drop policy "comments_insert_policy" on "public"."comments";

drop policy "comments_select_policy" on "public"."comments";

drop policy "tasks_delete_policy" on "public"."tasks";

drop policy "tasks_insert_policy" on "public"."tasks";

drop policy "tasks_select_policy" on "public"."tasks";

drop policy "tasks_update_policy" on "public"."tasks";
...
alter table "public"."activity_logs" add constraint "activity_logs_board_id_fkey" FOREIGN KEY (board_id) REFERENCES public.boards(id) ON DELETE CASCADE not valid;

alter table "public"."activity_logs" validate constraint "activity_logs_board_id_fkey";
...
alter table "public"."board_members" add constraint "board_members_board_id_fkey" FOREIGN KEY (board_id) REFERENCES public.boards(id) ON DELETE CASCADE not valid;

alter table "public"."board_members" validate constraint "board_members_board_id_fkey";

alter table "public"."columns" add constraint "columns_board_id_fkey" FOREIGN KEY (board_id) REFERENCES public.boards(id) ON DELETE CASCADE not valid;
...
alter table "public"."tasks" add constraint "tasks_column_id_fkey" FOREIGN KEY (column_id) REFERENCES public.columns(id) ON DELETE CASCADE not valid;

alter table "public"."tasks" validate constraint "tasks_column_id_fkey";

create or replace view "public"."board_members_with_emails" as  SELECT bm.id AS member_id,
    bm.board_id,
    bm.user_id,
    bm.role,
    u.email AS user_email,
...
with check ((EXISTS ( SELECT 1
  ...
  for select
  to public
using ((board_id IN ( SELECT public.get_accessible_boards(auth.uid()) AS get_accessible_boards)));
  ...
  for select
  to public
using ((id IN ( SELECT public.get_accessible_boards(auth.uid()) AS get_accessible_boards)));
...
using ((board_id IN ( SELECT boards.id
  ...
  create policy "columns_delete_policy"
  on "public"."columns"
  as permissive
  for delete
  to public
using ((EXISTS ( SELECT 1
  ...
  create policy "columns_insert_policy"
  on "public"."columns"
  as permissive
  for insert
  to public
with check ((EXISTS ( SELECT 1
  ...
  create policy "columns_select_policy"
  on "public"."columns"
  as permissive
  for select
  to public
using ((EXISTS ( SELECT 1
  ...
  create policy "columns_update_policy"
  on "public"."columns"
  as permissive
  for update
  to public
