...
Скопируйте содержимое файла схемы supabase/migrations/20260612095550_remote_schema.sql из репозитория проекта, вставьте его в редактор и нажмите Run. Схема таблиц, функции защиты RLS, вью и процедуры будут развернуты автоматически.
