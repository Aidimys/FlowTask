...
- **Файл схемы БД:** в `/supabase/migrations/20260612135202_remote_schema.sql`
...
2. **Отсутствие бинарного хранилища:** В текущей конфигурации к задачам не реализовано прикрепление файлов. В будущем планируется подключить **Supabase Storage** для загрузки скриншотов и документов к карточкам задач.
...
Скопируйте содержимое файла схемы supabase/migrations/20260612135202_remote_schema.sql из репозитория проекта, вставьте его в редактор и нажмите Run. Схема таблиц, функции защиты RLS, вью и процедуры будут развернуты автоматически.
